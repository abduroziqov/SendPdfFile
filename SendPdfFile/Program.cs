...
namespace SendPdfFile
{
    internal class Program
    {
        ...
        private static string INSTANCE_ID = "1368877670";
        private static string CLIENT_ID = "6780346192:AAFa_14tAzOpjj81mXdVs5iQ558wshuu2EU";
        ...
        {
            /*string botToken = "6780346192:AAFa_14tAzOpjj81mXdVs5iQ558wshuu2E+"; // Replace with your bot token
            long chatId = 1368877670; // Replace with the chat ID where you want to send the PDF
            ...
            Program pdfSender = new Program();
            // TODO: Put down your recipient's number (e.g. your own cell phone number)
            string recipient = "+998330356928";
            // TODO: Remember to copy the PDF from ..\assets to the TEMP directory!
            string base64Content = convertFileToBase64(@"C:\Users\abdur\OneDrive\Рабочий стол\pdf.pdf");
            string fn = "pdf.pdf";
